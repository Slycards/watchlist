...
function seasonHeatScore(d7Ops, d15Ops, d30Ops, seasonOps) {
  ...
  const raw = 5 + 0.5 * momentum + 0.5 * consistency;
  ...
  try {
    ...
    if (season) {
      heatScore = seasonHeatScore(
        splits.d7?.games >= HEAT_THRESHOLDS.d7.minGames ? splits.d7.ops : null,
        splits.d15?.games >= HEAT_THRESHOLDS.d15.minGames ? splits.d15.ops : null,
        splits.d30?.games >= HEAT_THRESHOLDS.d30.minGames ? splits.d30.ops : null,
        season.ops
      );
    }
